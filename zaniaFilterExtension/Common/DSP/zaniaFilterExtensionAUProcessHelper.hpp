//
//  zaniaFilterExtensionAUProcessHelper.hpp
...
#include <vector>
#include "zaniaFilterExtensionDSPKernel.hpp"
#include "zaniaFilterExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(zaniaFilterExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    zaniaFilterExtensionDSPKernel& mKernel;
